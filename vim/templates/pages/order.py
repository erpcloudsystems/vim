...
def get_context(context):
	...
	context.advace_payment_perc = frappe.get_doc("Selling Settings").advace_payment_perc
	context.Minumum_advance_amount=frappe.form_dict.grand_total*context.advace_payment_perc%100
	...
	if user :	
		...
		if p and p.get("user_type") != "System User": 
